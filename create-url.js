...
const MESSAGES = {
  ja: {
    ...
    start:'はじめる', what:'作成方法', start_hint:'作成方法の選択',
    scratch:'ゼロから作る', scratch_hint:'任意のキーと値', ga4_start:'WEBトラッキング', ga4_hint:'GA4 UTM', adobe_start:'Adobe用に作る', adobe_hint:'Tracking Code', edit_url:'既存URLを編集', edit_hint:'貼り付けて解析', open_saved:'保存済みのURLを編集 →',
    inspector:'URLを解析', inspector_title:'既存URL編集', reset:'入力をリセット', parse:'URLを解析', parse_hint:'既存のクエリ・ハッシュも残して編集できる。',
  ...
  en: {
    ...
    start:'START', what:'Create URL', start_hint:'Choose a starting point',
    scratch:'Start from scratch', scratch_hint:'Any key and value', ga4_start:'Web tracking', ga4_hint:'GA4 UTM', adobe_start:'Create an Adobe URL', adobe_hint:'Tracking Code', edit_url:'Edit an existing URL', edit_hint:'Paste and inspect it', open_saved:'Edit saved URLs →',
    inspector:'URL INSPECTOR', inspector_title:'Edit existing URL', reset:'Reset', parse:'Inspect URL', parse_hint:'Keep and edit existing queries and hashes.',
